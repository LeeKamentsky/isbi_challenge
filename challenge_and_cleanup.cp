...
SaveImages:[module_num:17|svn_version:\'Unknown\'|variable_revision_number:7|show_window:True|notes:\x5B\x5D|batch_state:array(\x5B\x5D, dtype=uint8)]
    ...
    Enter single file name:TrainPrediction
...
SaveImages:[module_num:18|svn_version:\'Unknown\'|variable_revision_number:7|show_window:True|notes:\x5B\x5D|batch_state:array(\x5B\x5D, dtype=uint8)]
    Select the type of image to save:Image
    ...
    Select method for constructing file names:Sequential numbers
    Select image name for file prefix:None
    Enter single file name:SegmentationPicture
    Do you want to add a suffix to the image file name?:No
    Text to append to the image name:
    Select file format to use:tif
    Output file location:Default Output Folder\x7CNone
